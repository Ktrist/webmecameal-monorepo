...
const SUBSCRIPTION_PLANS = [
  {
    ...
    frequency: 'semaine',
    daysPerWeek: 2,
    stripePriceId: STRIPE_PRICES.HEBDO_2J || 'price_1SabLCEx4HxCpNJ2hpgpHExI',
    features: [
      '2 repas par semaine',
      '12.90€ par repas',
      'Livraison gratuite',
  ...
  },
  {
    ...
    frequency: 'semaine',
    daysPerWeek: 3,
    stripePriceId: STRIPE_PRICES.HEBDO_3J || 'price_1SabMHEx4HxCpNJ2mDycvUW5',
    features: [
      '3 repas par semaine',
      '11.90€ par repas',
      'Livraison gratuite',
  ...
  },
  {
    ...
    frequency: 'semaine',
    daysPerWeek: 5,
    stripePriceId: STRIPE_PRICES.HEBDO_5J || 'price_1SabNQEx4HxCpNJ2fsciiPLU',
    features: [
      '5 repas par semaine',
      '10.90€ par repas',
      'Livraison gratuite',
  ...
  },
  {
    ...
    frequency: 'mois',
    isFlexible: true,
    stripePriceId: STRIPE_PRICES.MENSUEL || 'price_1SabNnEx4HxCpNJ26hfmuUmM',
    features: [
      'À partir de 10€/mois',
