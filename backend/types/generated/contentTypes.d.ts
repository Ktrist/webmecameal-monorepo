...
export interface ApiFicheRecetteFicheRecette
  extends Struct.CollectionTypeSchema {
  collectionName: 'fiche_recettes';
  info: {
    displayName: 'Fiche Recette';
    pluralName: 'fiche-recettes';
    singularName: 'fiche-recette';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    details_recette: Schema.Attribute.RichText &
      ...
      >;
    image_marketing: Schema.Attribute.Media<
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    supabase_menu_id: Schema.Attribute.Integer;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    navigation: Schema.Attribute.Component<'elements.lien', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    recipe_details: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor.CKEditor',
        {
          licenseKey: 'eyJhbGciOiJFUzI1NiJ9.._FgL4N6ste_QZTA3-xIDP5Hh1xuQe_izfv7mAiwew1mdbA5JbZ1QBXDnbL2O9FFopXIUCGLgTtaAHwrzbrQsBg';
      ...
      >;
    supabase_id: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blocs: Schema.Attribute.DynamicZone<
      [
        'blocs-page.hero',
        'blocs-page.grille-menus',
        'blocs-page.content-block',
        'elements.offer-card',
        'elements.lien',
        'blocs-page.pricing-grid',
        'blocs-page.testimonials-grid',
        'blocs-page.questions',
        'blocs-page.features',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::fiche-recette.fiche-recette': ApiFicheRecetteFicheRecette;
